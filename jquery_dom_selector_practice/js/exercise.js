...
// When the figure containing the class name "city" is selected, change the attribute associate to the image with the source: http://lorempixel.com/g/500/400/food.  
...
$("#button3").click(question9);
	function question9(){
		$('p').css('font-family','Georgia').css('color', 'blue');
	}
